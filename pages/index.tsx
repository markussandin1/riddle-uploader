      ...
      <main className="container">
        <div className="header">
          <div className="hero-section">
            ...
            <h1 className="hero-title">Bonnier Quiz Generator</h1>
          </div>
          </div>
        ...
        <div className="main-grid">
          ...
          <section className="card main-card">
            <div className="card-header">
              ...
              <h2>Skapa nytt quiz</h2>
            </div>
            <form onSubmit={triggerManual} className="quiz-form">
              <div className="form-field">
                <label htmlFor="title" className="field-label">Vilken sida vill du skapa quiz för?</label>
                <input
                  id="title"
                  type="text"
                  value={customTitle}
                  onChange={(e) => setCustomTitle(e.target.value)}
                  placeholder="ex. sydsvenskan.se, st.nu, gd.se"
                  required
          ...
          <details className="tech-details">
            ...
            <div className="tech-content">
              <div className="tech-item">
                <label className="tech-label">Använd den här URL:en i triggern för Workflowet</label>
          ...
          <section className="card quiz-results-card">
            ...
            {createdQuizzes.length > 0 ? (
              ...
              <div className="empty-state">
                ...
                <h3>Inga quiz än</h3>
                <p>Skapa ditt första quiz för att se det här</p>
              </div>
            )}
          </section>
          ...
          <section className="card recent-requests">
            ...
            {feedItems.length > 0 ? (
              ...
              <div className="empty-state">
                ...
                <h3>Inga skapade quiz än</h3>
                <p>Dina quizförfrågningar kommer att visas här</p>
              </div>
            )}
          </section>
        </div>
